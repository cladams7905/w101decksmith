              ...
              <div key={comment.id} className="p-4">
                <div className="flex gap-3">
                  <Avatar className="h-8 w-8">
                    ...
                    <AvatarFallback className={`bg-${getSchoolColor(comment.author.school)}-700`}>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-2">
                      ...
                      >
                        <Heart className={`h-4 w-4 mr-1 ${comment.liked ? "fill-red-500 text-red-500" : ""}`} />
                        {comment.likes}
                      </Button>
                      <Button
                        variant="ghost"
                          ...
                          <div key={reply.id} className="pt-3">
                            <div className="flex gap-2">
                              <Avatar className="h-6 w-6">
                                ...
                                <AvatarFallback className={`bg-${getSchoolColor(reply.author.school)}-700 text-xs`}>
                              ...
                              <div className="flex-1">
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                  ...
                                  >
                                    <Heart
                                      className={`h-3 w-3 mr-1 ${reply.liked ? "fill-red-500 text-red-500" : ""}`}
                                    />
                                    {reply.likes}
                                  </Button>
                                </div>
