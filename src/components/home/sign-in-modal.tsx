...
export default function SignInModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      {children}
      <DialogContent className="sm:max-w-md backdrop-blur-3xl text-white overflow-hidden">
        ...
        <div className="space-y-3">
          <Button variant="outline_primary" className="w-full text-white">
            <svg
          ...
          <Button variant="outline_white" className="w-full">
            <svg
              className="w-5 h-5 mr-2"
              viewBox="0 0 24 24"
              fill="currentColor"
        ...
        <div className="space-y-4">
          ...
          <div className="text-center">
            <button
              onClick={() =>
                onLoginModeChange(loginMode === "login" ? "signup" : "login")
              }
