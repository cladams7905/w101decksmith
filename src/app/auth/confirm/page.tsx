          ...
          {error && !loading && (
            <div className="text-center">
              ...
              <p className="text-white/60 text-sm mb-6">
                There was a problem confirming your account. You can try signing
                up again or contact support if the issue persists.
              </p>
          ...
          {success && !loading && !error && (
            <div className="text-center">
              ...
              <p className="text-white/60 text-sm mb-4">
                Your account has been successfully confirmed. Redirecting you
                now...
              </p>
